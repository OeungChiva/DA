...
<body class="app sidebar-mini rtl">
    ...
    <ul class="app-menu">
        ...
        <li class="treeview is-expanded">
            ...
            <ul class="treeview-menu">
                <li>
                    <a class="treeview-item active" href="{{url('/admin/menu')}}">
                    ...
                    <div class="table-title">
                        <div class="row">                
                            ...
                            <div class="col-sm-2">
                                ...
                                <button type="button" class="btn btn-info add-new"><i class="fa fa-plus"></i> Add New Menu</button>
                                </a>
                            </div>
                        </div><br>
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a class="edit text-warning" href="{{url('/admin/update_menu/'.$row->id)}}" title="Update" data-toggle="tooltip">
                                    <i class="fa fa-edit"></i>
                                    </a>                        
                                    &nbsp;
                                    <a class="delete text-danger" href="{{url('/admin/menu/'.$row->id)}}" onclick="return confirm('Are you sure?')" title="Delete" data-toggle="tooltip">
