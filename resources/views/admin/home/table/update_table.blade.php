...
<body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-th-list"></i> Update Table</h1>          
            </div>
            <ul class="app-breadcrumb breadcrumb side">
                <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
                <li class="breadcrumb-item">Tables</li>
                <li class="breadcrumb-item active"><a href="#">Update Tables</a></li>
            </ul>
        </div>
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="tile">               
                    ...
                    <div class="tile-body">
                        ...
                        @endif
                        <form class="form-horizontal" method="POST" action="{{url('/admin/update_table/'.$table->id)}}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group row">
                                <label class="control-label col-md-3">Name</label>
                                <div class="col-md-8">
                                    <input class="form-control" name="table_name" type="text" value="{{$table->name}}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="control-label col-md-3">Number of Guest</label>
                                <div class="col-md-8">
                                    <input class="form-control" name="table_guest" type="number" min="1" value="{{$table->guest}}">
                                </div>
                            </div>
