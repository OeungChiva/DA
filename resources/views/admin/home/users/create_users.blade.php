        ...
        <ul class="app-menu">
            ...
            <li class="treeview is-expanded">
                ...
                <ul class="treeview-menu">
                    ...
                    <li>
                        <a class="treeview-item active" href="{{url('/admin/create_users')}}">
            ...
            <div class="col-md-8">
                <div class="tile">               
                    ...
                    <div class="tile-body">
                        ...
                        @endif
                        <form class="form-horizontal" method="POST" action="{{ route('admin.create_users.post') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" name="user_email" type="email" placeholder="Enter email address">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input class="form-control" name="user_phone" type="text" placeholder="Enter phone">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="control-label col-md-3">Address</label>
                                <div class="col-md-8">
                                    <input class="form-control" name="user_address" placeholder="Enter your address">
                                </div>
                            </div>                           
                            <div class="form-group row">
