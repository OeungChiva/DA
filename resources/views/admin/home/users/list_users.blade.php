                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <a class="edit text-warning" href="{{url('/admin/update_users/'.$row->id)}}" title="Update" data-toggle="tooltip">
                          <i class="fa fa-edit"></i>
                        </a>                        
                        &nbsp;
                        <a class="delete text-danger" href="{{url('/admin/users/'.$row->id)}}" onclick="return confirm('Are you sure?')" title="Delete" data-toggle="tooltip">
